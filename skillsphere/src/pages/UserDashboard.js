  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-bold text-gray-800">SkillSphere</h1>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Welcome Section */}
        <div className="bg-gradient-to-br from-purple-600 to-purple-900 rounded-2xl shadow-lg p-8 mb-8 text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="mb-4">
              ...
              <select
                ...
                className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-purple-600 text-sm"
            ...
            <button
              ...
              className="w-full px-4 py-3 bg-gradient-to-r from-purple-600 to-purple-900 text-white rounded-lg hover:shadow-lg transition-all font-medium disabled:opacity-60 disabled:cursor-not-allowed"
            >
            ...
            {gapAnalysis && (
              <div className="mt-6 space-y-4">
                {/* Summary Card */}
                <div className="bg-gradient-to-br from-purple-600 to-purple-900 rounded-lg p-6 text-white">
                  <h4 className="text-lg font-bold mb-2">Analysis Results</h4>
                  <p className="text-purple-100 mb-4">{gapAnalysis.summaryMessage}</p>
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-4 text-center">
                    <div>
                      ...
                      <div className="text-xs text-purple-200">Skills You Have</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold">{gapAnalysis.missingSkills}</div>
                      <div className="text-xs text-purple-200">Missing Skills</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold">{gapAnalysis.totalRequiredSkills}</div>
                      <div className="text-xs text-purple-200">Total Required</div>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-3">
              <button className="w-full px-4 py-3 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 transition-colors text-left font-medium">
